...
public interface Connection extends AutoCloseable {
    ...
    /**
     * Create a {@code Dispatcher} for this connection. This method functions the same as
     * {@code Connection#createDispatcher(MessageHandler)} however, this method exposes an option to
     * allow duplicate subscriptions to be created.
     *
     * <p>Use the Dispatcher's {@link Dispatcher#subscribe(String)} and
     * {@link Dispatcher#subscribe(String, String)} methods to add subscriptions.
     *
     * <pre>
     * d = nc.createDispatcher((m) -&gt; System.out.println(m + " with sid: " + m.getSubscription().getSID()),
     *                         true);
     * for (int i = 0; i &lt; 10; i++) {
     *     d.subscribe("hello");
     * }
     ...
     *
     * @param handler The target for the messages
     * @param allowDuplicateSubscriptions Flag allowing duplicate calls to the subscribe method for any
     *                    subscription name. The default behavior is to ignore duplicate subscriptions.
     * @return a new Dispatcher
     */
